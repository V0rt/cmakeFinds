...
# Добавляем поддержку Windows
if(WIN32 AND NOT FFTW_ROOT)
    # Проверяем стандартные пути установки FFTW на Windows
    set(FFTW_POSSIBLE_ROOTS
        "C:/fftw3"
        "C:/fftw"
        "$ENV{PROGRAMFILES}/fftw3"
        "$ENV{PROGRAMFILES(X86)}/fftw3"
    )
    
    # Ищем FFTW в стандартных путях
    foreach(FFTW_POSSIBLE_ROOT ${FFTW_POSSIBLE_ROOTS})
        if(EXISTS "${FFTW_POSSIBLE_ROOT}/include/fftw3.h")
            set(FFTW_ROOT ${FFTW_POSSIBLE_ROOT})
            break()
        endif()
    endforeach()
endif()
